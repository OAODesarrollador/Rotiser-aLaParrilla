                            ...
                            <div key={`${item.id}-${idx}`} className={styles.item}>
                                <div className={styles.itemDetails}>
                                    ...
                                    <div className={styles.controls}>
                                        <button className={styles.qtyBtn} onClick={() => updateQuantity(item.id, item.isCombo, -1)}>
                                            <Minus size={14} />
                                        </button>
                                        ...
                                        <button className={styles.removeBtn} onClick={() => removeFromCart(item.id, item.isCombo)}>
                                            <Trash2 size={16} />
                                        </button>
                                    </div>
                                </div>
